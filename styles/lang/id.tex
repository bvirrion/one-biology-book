% ============================================================================
% Indonesian UI and structural strings for the One Biology Book series.
% Loaded by styles/onebiology.sty when \booklang is id.
%
...
\newcommand{\booktagline}{Satu Buku Biologi untuk Menguasai Semuanya}
\newcommand{\bookdescription}{Biologi dari taman kanak-kanak hingga akhir program sarjana}
\newcommand{\bookcontributors}{Para kontributor One Biology Book}
...
% onebiology.sty. Identical to the singulars on purpose (see the header).
...
% is optional here (see onebiology.sty), so declare them anyway.
