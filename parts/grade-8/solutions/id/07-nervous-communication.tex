...
Keterstelan (\omterm{def:g8:nervous-communication:synapse}{sinapsisnya} menguat karena dipakai dan memudar
...
\omterm{def:g8:nervous-communication:synapse}{sinapsisnya} --- jalur yang dihitung itu adalah masukan yang
...
\omterm{def:g8:nervous-communication:synapse}{sinapsisnya} berarti keberatan \omterm{def:g5:brain-in-command:system}{otaknya} yang datang kemudian
...
tetap terangkai ke dalam keseluruhannya, dan \omterm{def:g8:nervous-communication:synapse}{sinapsisnya}
mendengar lebih banyak daripada uratnya saja.

\textbf{8.} \omterm{def:g8:nervous-communication:synapse}{Sinapsisnya} --- dan pengisyaratan seratnya pada
