...
{\small The \omterm{def:g10:common-ancestry:bodyplan}{vertebrate} \omterm{def:g10:common-ancestry:bodyplan}{body plan}, in side view. Whatever the \omterm{def:g10:biodiversity-scales:species}{species},
...
Two organs of two \omterm{def:g10:biodiversity-scales:species}{species} are \emph{homologous}\index{homology} when
...
that possessed them; the more such structures two \omterm{def:g10:biodiversity-scales:species}{species} share, the
...
one \omterm{def:g10:universal-dna:gene}{gene} rank \omterm{def:g10:biodiversity-scales:species}{species} exactly as the anatomy does.
\end{proof}
...
its descendants.
\begin{enumerate}
  \item List the \omterm{def:g10:biodiversity-scales:species}{species} and a set of characters (vertebral column;
        four limbs; egg with a shell or its equivalent, the amniotic
        egg; feathers; hair and milk; and so on).
  \item For each character, note which \omterm{def:g10:biodiversity-scales:species}{species} possess it.
  \item A character shared by a subset defines a group: all \omterm{def:g10:biodiversity-scales:species}{species}
...
pigeon? The smallest box containing the mouse and another \omterm{def:g10:biodiversity-scales:species}{species} is
...
in two \omterm{def:g10:biodiversity-scales:species}{species} is a modified copy of the ancestral \omterm{def:g10:universal-dna:gene}{gene}, and the
number of differences between the two copies grows with the time since
the \omterm{def:g10:biodiversity-scales:species}{species} separated. Comparing the sequence of one \omterm{def:g10:universal-dna:gene}{gene}, or of the
\omterm{def:g10:chemistry-of-life:families}{protein} it codes for, across \omterm{def:g10:biodiversity-scales:species}{species} therefore measures kinship, and
...
by differences, the \omterm{def:g10:biodiversity-scales:species}{species} fall into exactly the boxes of the
...
The class studies five \omterm{def:g10:biodiversity-scales:species}{species}: a trout, a frog, a lizard, a pigeon and
...
\begin{enumerate}
  ...
  \item Which characters define a group of four, a group of three?
        Name the groups.
  \item Feathers and hair are each found in one \omterm{def:g10:biodiversity-scales:species}{species}. Can such a
        character define a kinship group among these five? What is it
        useful for?
  \item Draw the nested boxes for the five \omterm{def:g10:biodiversity-scales:species}{species}, or the
        corresponding tree.
...
\begin{enumerate}[resume]
  \item From the second table, which two \omterm{def:g10:biodiversity-scales:species}{species} are the closest
        pair? Which \omterm{def:g10:biodiversity-scales:species}{species} is most distant from all the others?
...
\begin{enumerate}[resume]
  ...
  \item Why is agreement between an anatomical and a molecular
        ...
        questioned?
  \item Suppose a sixth \omterm{def:g10:biodiversity-scales:species}{species}, a bat, were added: forelimb with the
  ...
  \item The cytochrome c of a chimpanzee is identical to the human
        one, yet the two \omterm{def:g10:biodiversity-scales:species}{species} differ visibly. What does this say
...
\begin{enumerate}[resume]
  ...
  \item State the result in one sentence: what the two kinds of
        evidence, taken together, establish about the five \omterm{def:g10:biodiversity-scales:species}{species},
