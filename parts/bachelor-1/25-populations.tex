...
$\ln 2/r$; a \omterm{def:b1:populations:population}{population} with $r = \qty{0.11}{year^{-1}}$ doubles in
\qty{6.3}{years}, one with $r = \qty{0.5}{h^{-1}}$ in \qty{83}{min}.
...
A logistic \omterm{def:b1:populations:population}{population} has $K = 1000$ and $r = \qty{0.2}{year^{-1}}$.
...
\begin{enumerate}[resume]
  ...
  \item The perch \omterm{def:b1:populations:population}{population} has $K = 1000$ and $r = \qty{0.4}{year^{-1}}$.
