...
\begin{itemize}
  ...
  \item \omterm{prop:g3:sorting-living-things:groups}{serangga} menambahkan jawaban keempat: kebanyakan melewati
        ...
        spesiesnya melewati musim dingin sebagai tahap mudanya.
\end{itemize}
\end{proposition}
\admitted
...
spesiesnya berada di tempat lain (\omterm{def:g3:animals-through-seasons:migration}{bermigrasi}), tertidur
