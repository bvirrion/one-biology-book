...
\index{symbiosis}\index{parasite}\index{mycorrhiza}\index{lichen}
...
is one that benefits both: the \emph{mycorrhiza} (a fungus on or in
...
\qty{0.5}{mL} with $r_A = \qty{0.8}{day^{-1}}$; species B reaches
$K_B = 130$ with $r_B = \qty{0.55}{day^{-1}}$. Together, an individual
of B uses as much food as $\alpha = 1.6$ of A, and an individual of A
...
\begin{enumerate}[resume]
  ...
  \item The beetle's prey grow logistically with $r = \qty{0.1}{day^{-1}}$
